...
// ecrecover extracts the Genchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Genchain address
...
// Genchain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Genchain address of the signing key
...
// Author implements consensus.Engine, returning the Genchain address recovered
...
func (c *Clique) CalcDifficultyBygen(header *types.Header, parent *types.Header, parent12 *types.Header) (uint64, uint64, *big.Int, *big.Int) {
	return params.N, params.P, nil, nil
}
