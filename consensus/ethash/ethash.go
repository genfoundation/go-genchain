...
// all blocks' seal as valid, though they still have to conform to the Genchain
// consensus rules.
...
// still have to conform to the Genchain consensus rules.
...
// they still have to conform to the Genchain consensus rules.
