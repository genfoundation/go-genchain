...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		res[1] = strconv.FormatUint(block.N(),10)
		...
		//var P uint64 
		//P=5
		//res[2] =  strconv.FormatUint(P,10)
		res[2] =  strconv.FormatUint(block.P(),10)

		a.work[block.HashNoNonce()] = a.currentWork

		//fmt.Println("remote_agent.go GetWrok()",res[0],res[1],res[2])
...
func (a *RemoteAgent) SubmitWork(nonce types.BlockNonce, mixDigest, hash,fuzzyhash common.Hash) bool {
