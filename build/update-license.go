...
var (
	...
	authorsFileHeader = "# This is the official list of go-genchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-genchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-genchain library"
	}
	return "the go-genchain library"
}
