Name "ggen ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/genchain/go-genchain/issues"
!define UPDATEURL "https://github.com/genchain/go-genchain/releases"
!define ABOUTURL "https://github.com/genchain/go-genchain#genchain-go"
...
# Install ggen binary
Section "Ggen" GGEN_IDX
  SetOutPath $INSTDIR
  file {{.Ggen}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ggen.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ggen.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Ggen incoming peers (TCP:60606)"
  SimpleFC::AdvRemoveRule "Ggen outgoing peers (TCP:60606)"
  SimpleFC::AdvRemoveRule "Ggen UDP discovery (UDP:60606)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Ggen incoming peers (TCP:60606)" ""  6 1 1 2147483647 1 "$INSTDIR\ggen.exe" "" "" "Genchain" 60606 "" "" ""
  SimpleFC::AdvAddRule "Ggen outgoing peers (TCP:60606)" ""  6 2 1 2147483647 1 "$INSTDIR\ggen.exe" "" "" "Genchain" "" 60606 "" ""
  SimpleFC::AdvAddRule "Ggen UDP discovery (UDP:60606)" "" 17 2 1 2147483647 1 "$INSTDIR\ggen.exe" "" "" "Genchain" "" 60606 "" ""

  # Set default IPC endpoint (https://github.com/genchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\ggen.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\ggen.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GGEN_IDX}
    SectionGetSize ${GGEN_IDX} $0
