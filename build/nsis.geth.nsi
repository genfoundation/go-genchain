...
# 1. install ggen for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ggen
# 5. create ggen, attach and uninstall start menu entries
...
!define GROUPNAME "Genchain"
!define APPNAME "Ggen"
!define DESCRIPTION "Official Go implementation of the Genchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ggen is installed global
