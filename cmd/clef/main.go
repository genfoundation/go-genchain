...
import (
	...
	"github.com/genchain/go-genchain/signer/core"
	"github.com/genchain/go-genchain/signer/rules"
	"github.com/genchain/go-genchain/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Genchain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
