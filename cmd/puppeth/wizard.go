...
type wizard struct {
	...
	services map[string][]string   // Genchain services known to be running on servers
...
// converts it to an Genchain address. If an empty line is entered, the default
// value is returned.
