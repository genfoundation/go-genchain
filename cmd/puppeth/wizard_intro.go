...
// setting up a new or managing an existing Genchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Genchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Genchain network down to  |")
	...
	log.Info("Administering Genchain network", "name", w.network)
