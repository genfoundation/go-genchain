...
func testDAOForkBlockNewChain(t *testing.T, test int, genesis string, expectBlock *big.Int, expectVote bool) {
	...
	// Start a Ggen instance with the requested flags set and immediately terminate
	if genesis != "" {
		...
		ggen := runGeth(t, append(args, []string{"--exec", "2+2", "console"}...)...)
		ggen.WaitExit()
	}
	// Retrieve the DAO config flag from the database
	path := filepath.Join(datadir, "ggen", "chaindata")
