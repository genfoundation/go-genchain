...
// See https://github.com/genchain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Genchain presale wallet and stores
