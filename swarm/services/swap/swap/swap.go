...
type Strategy struct {
	...
	AutoCashThreshold    *big.Int      // threshold that triggers autocash (shao)
	AutoDepositInterval  time.Duration // default interval for autocash
	AutoDepositThreshold *big.Int      // threshold that triggers autodeposit (shao)
	AutoDepositBuffer    *big.Int      // buffer that is surplus for fork protection etc (shao)
}
