...
// a Ggen console and call it with a transaction hash you which to export.
...
var makeTest = function(tx, rewind) {
  ...
  var block   = gen.getBlock(gen.getTransaction(tx).blockHash);
  var genesis = gen.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.gen.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  gen.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
