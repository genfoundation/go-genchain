...
// Syncing provides information when this nodes starts synchronising with the Genchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  genchain.SyncProgress `json:"status"`
}
