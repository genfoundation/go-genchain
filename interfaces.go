...
// Package genchain defines interfaces for interacting with Genchain.
package genchain
...
type CallMsg struct {
	...
	GasPrice *big.Int        // shao <-> gas exchange ratio
	Value    *big.Int        // amount of shao sent along with the call
