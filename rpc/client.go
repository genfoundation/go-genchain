...
const (
	...
	subscribeTimeout     = 5 * time.Second  // overall timeout gen_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscripion under the "gen" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "gen", channel, args...)
}
