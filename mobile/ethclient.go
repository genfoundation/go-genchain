...
// Contains a wrapper for the Genchain client.
...
// EthereumClient provides access to the Genchain APIs.
...
// GetBalanceAt returns the shao balance of the given account.
...
// GetPendingBalanceAt returns the shao balance of the given account in the pending state.
