...
// Contains all the wrappers from the go-genchain root package.
...
// the Genchain network.
type SyncProgress struct {
	progress genchain.SyncProgress
}
