...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ggen.ipc", false, filepath.Join(os.TempDir(), "ggen.ipc")},
		{"data", "ggen.ipc", false, "data/ggen.ipc"},
		{"data", "./ggen.ipc", false, "./ggen.ipc"},
		{"data", "/ggen.ipc", false, "/ggen.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ggen.ipc", true, `\\.\pipe\ggen.ipc`},
		{"data", "ggen.ipc", true, `\\.\pipe\ggen.ipc`},
		{"data", `\\.\pipe\ggen.ipc`, true, `\\.\pipe\ggen.ipc`},
	}
