...
func TestHash1(t *testing.T) {
	fmt.Println("atool.org :hash test")
	msg := []byte("atool.org")
	exp, _ := hex.DecodeString("105daae16ca97797671791c1bcde6a06a0ec981d8e7090d0ff021d99a03b9c59")
	checkhash(t, "Sha3-256-array", func(in []byte) []byte { h := Keccak256Hash(in); return h[:] }, msg, exp)
}

func TestHash2(t *testing.T) {
	fmt.Println("atool.org6:hash test2")
	msg := []byte("atool.org")

	h := Keccak256(msg)
	hashstring := hex.EncodeToString(h)
	fmt.Println("105daae16ca97797671791c1bcde6a06a0ec981d8e7090d0ff021d99a03b9c59")
