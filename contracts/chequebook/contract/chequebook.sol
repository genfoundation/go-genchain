...
/// @title Chequebook for Genchain micropayments
/// @author Daniel A. Nagy <daniel@genchain.org>
contract chequebook is mortal {
    // Cumulative paid amount in shao to each beneficiary
    mapping (address => uint256) public sent;

    /// @notice Overdraft event
    event Overdraft(address deadbeat);

    // Allow sending genc to the chequebook.
    function() public payable { }

    /// @notice Cash cheque
    ///
    /// @param beneficiary beneficiary address
    /// @param amount cumulative amount in shao
