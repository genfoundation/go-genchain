...
// Package chequebook package wraps the 'chequebook' Genchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in genc; (auto)cashing cheques in genc
// as well as (auto)depositing genc to the chequebook contract.
package chequebook
...
// * depositing genc to the chequebook
// * watching incoming genc
...
// Cash cashes the cheque by sending an Genchain transaction.
