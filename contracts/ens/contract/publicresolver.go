...
import (
	...
	genchain "github.com/genchain/go-genchain"
	"github.com/genchain/go-genchain/accounts/abi"
	"github.com/genchain/go-genchain/accounts/abi/bind"
...
// DeployPublicResolver deploys a new Genchain contract, binding an instance of PublicResolver to it.
...
// PublicResolver is an auto generated Go binding around an Genchain contract.
...
// PublicResolverCaller is an auto generated read-only Go binding around an Genchain contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an Genchain contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverFilterer is an auto generated log filtering Go binding around an Genchain contract events.
type PublicResolverFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an Genchain contract,
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an Genchain contract,
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an Genchain contract,
...
// PublicResolverRaw is an auto generated low-level Go binding around an Genchain contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw methods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an Genchain contract.
...
// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an Genchain contract.
